...
if [ "${INPUT_RUN_DIRECTORY}" = "yes" ]; then
  ...
  echo "git remote set-url ${INPUT_REMOTE} git@github.com:${INPUT_USERNAME}/${INPUT_REPO}.git"
  git remote set-url ${INPUT_REMOTE} git@github.com:${INPUT_USERNAME}/${INPUT_REPO}.git
